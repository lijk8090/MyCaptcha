...
<body>
	<h1>MyCaptcha</h1>
	<div>
		<img id="simpleImage" src="simpleCaptcha.do" width="200px"
			height="50px" />
	</div>
	<div>
	...
	<div>
		<input type="text" value="" id="verCode" /> <input type="button"
			value="校验" id="loginID" />
	</div>

	<script type="text/javascript">
		$('#simpleImage').click(function() {
			return $('#simpleImage').attr('src', 'simpleCaptcha.do');
		});
